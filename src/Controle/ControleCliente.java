...
public class ControleCliente{
    ...
    public void cadastrarCliente (String nome, String dataNascimento, String endereco, String cpf,  String email, String senha) throws ClassNotFoundException, FileNotFoundException, IOException{

    Cliente c = new Cliente(nome, dataNascimento, endereco, cpf,  email, senha);
    c.cadastrarCliente(c);
  }

  /*public String imprimirCliente() throws IOException, FileNotFoundException, ClassNotFoundException {
    String cliente = "";
